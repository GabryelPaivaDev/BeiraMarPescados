...
document.addEventListener('DOMContentLoaded', function () {
  ...
  setTimeout(function () {
    ...
    // Aguarda header.js estar pronto antes de inicializar
    setTimeout(function () {
      initNotificationDropdown();
      
      // Atualiza badges via header.js (preferencial) ou notificacoes.js
      if (window.BeiraMarHeader && window.BeiraMarHeader.updateBadgeCount) {
        window.BeiraMarHeader.updateBadgeCount();
